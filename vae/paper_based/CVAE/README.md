...
This version uses PyTorch and saves checkpoints as `.pt` files.
...
```
python sample.py --prop_file=smiles_prop.txt --save_file=save/model_3.ckpt-3.pt --target_prop='300 4 100' --result_filename=result.txt
```
