...
def _sample_batch_strings(
    *,
    ...
    from .core import convert_to_smiles
...
def compose_runtime_sample_config(runtime_config: dict) -> dict:
    ...
    return {
        ...
        'suppress_rdkit_parse_errors': sampling.get('suppress_rdkit_parse_errors', True),
        ...
        'exclude_test_scaffolds': filters.get('exclude_test_scaffolds', False),
        'test_scaffold_csv': filters.get('test_scaffold_csv', None),
        'test_scaffold_smiles_column': filters.get('test_scaffold_smiles_column', 'smiles'),
